...
>(({ className, align = "start", alignOffset = -4, sideOffset = 8, style, ...props }, ref) => {
  const localRef = React.useRef<React.ElementRef<typeof MenubarPrimitive.Content>>(null);
  ...
  return (
    <MenubarPrimitive.Portal>
      <MenubarPrimitive.Content
        ...
        className={cn(
          "apple-origin-float-motion z-50 min-w-[12rem] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md",
          className,
        )}
        {...props}
      />
